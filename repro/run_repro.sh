...
mkdir -p .codex_tmp/hodge_closure
cp artifacts/stitch_constants.json .codex_tmp/hodge_closure/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/hodge_closure/constants_registry.json

python3 scripts/hodge_closure_guard.py \
  --strict-coh-zero \
  --registry artifacts/constants_registry.json \
  --stitch artifacts/stitch_constants.json \
